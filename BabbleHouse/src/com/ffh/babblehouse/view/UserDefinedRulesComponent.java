...
public class UserDefinedRulesComponent extends CustomComponent {
	...
	public UserDefinedRulesComponent(MainUI mainUI, UI ui, List<DtoServiceGroup> serviceGroupList) {
		this.mainUI = mainUI;
		this.ui = ui;
	...
	private void buttonsConfiguration() {
		...
		final Window addUserDefinedRuleWindow = new AddUserDefinedRuleWindow(mainUI, serviceGroupList);
	...
	private void fillTableHeader() {
		...
		userDefinedRulesTable.addContainerProperty("Actuator",  String.class, null);
	}
