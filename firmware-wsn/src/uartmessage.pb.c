...
/* Generated by nanopb-0.2.7 at Sat May 31 13:13:23 2014. */
...
const pb_field_t Beacon_fields[4] = {
    ...
    PB_FIELD2(  3, MESSAGE , REPEATED, CALLBACK, OTHER, Beacon, service, name, &Service_fields),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(UARTMessage, beacon) < 65536 && pb_membersize(UARTMessage, service) < 65536 && pb_membersize(Beacon, service) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_UARTMessage_Service_Beacon)
#endif
 ...
 * 8 bit descriptors.
 */
STATIC_ASSERT((pb_membersize(UARTMessage, beacon) < 256 && pb_membersize(UARTMessage, service) < 256 && pb_membersize(Beacon, service) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_UARTMessage_Service_Beacon)
#endif
